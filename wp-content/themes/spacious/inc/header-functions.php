...
if ( ! function_exists( 'spacious_featured_image_slider' ) ) :
	...
	function spacious_featured_image_slider() {
		global $post;
		?>
		<section id="featured-slider" style="padding-top: 97px;">
						...
						<div class="<?php echo $classes; ?>">
							<figure>
								...
								<?php if ( ! empty ( $image_attributes ) ) { ?>
									<img width="<?php echo esc_attr( $image_attributes[1] ); ?>" alt="<?php echo esc_attr( $img_alt ); ?>" src="<?php echo esc_url( $spacious_slider_image ); ?>" style="height:412px;" >
								<?php } else { ?>
